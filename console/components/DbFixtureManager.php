 ...
 * into the database.
 *
 * @property DbConnection $dbConnection The database connection.
 * @property array $fixtures The information of the available fixtures (table name => fixture file).
 *
 * @author Philipp Frenzel <qiang.xue@gmail.com>
...
class DbFixtureManager extends Component
{
	...
	public function init()
	{
		...
		if($this->basePath===null)
			$this->basePath=Yii::getPathOfAlias('application.tests.fixtures'); //this is still a todo, as i'm not sure about syntax
		$this->prepare();
	}
